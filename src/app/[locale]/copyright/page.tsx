...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Kingdom Architect Wiki',
    description: 'Copyright and intellectual property information for Kingdom Architect Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Kingdom Architect Wiki',
      description: 'Copyright and intellectual property information for Kingdom Architect Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Kingdom Architect Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Kingdom Architect Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Kingdom Architect Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Finite Works</strong> - Creators of the Kingdom Architect game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Kingdom Architect</strong> - Trademark of Finite Works</li>
              <li><strong>Kingdom Architect Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Kingdom Architect Wiki.
            </p>
            ...
            <p>
              ...
              Kingdom Architect Wiki<br />
              Email: <a href="mailto:dmca@kingdom-architect.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@kingdom-architect.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Kingdom Architect Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Kingdom Architect Wiki (kingdom-architect.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@kingdom-architect.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@kingdom-architect.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@kingdom-architect.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@kingdom-architect.wiki</a>
            </p>
            <p>
